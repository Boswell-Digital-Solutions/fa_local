...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/FLLSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "Primary output: \`doc/FLLSYSTEM.md\`" "index primary output"
...
require_contains "$ASSEMBLED_OUTPUT" "Primary output: \`doc/FLLSYSTEM.md\`" "assembled primary output"
